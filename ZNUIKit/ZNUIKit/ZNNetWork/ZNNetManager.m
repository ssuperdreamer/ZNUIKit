...
+ (void)setBaseUrl:(NSString * _Nonnull) baseUrl{
    [ZNNetRequest setAppBaseUrl:baseUrl];
}
...
+ (NSURLSessionDownloadTask *)downFileWith:(NSString*)urlStr
                                  progress:(ZNNetRequestProgress)progress
                               destination:(ZNNetRequestDestination )destination
                         completionHandler:(ZNNetRequestDownCompletionHandler)completionHandler{
   return [ZNNetRequest downFileWith:urlStr progress:progress destination:destination completionHandler:completionHandler];
}

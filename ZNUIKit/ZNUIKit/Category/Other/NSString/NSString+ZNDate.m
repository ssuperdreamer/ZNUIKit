...
- (NSString *)zn_format_HH{
    NSDate *date = [NSDate zn_dateWithDateString:self];
    return [NSString stringWithFormat:@"%02ld",date.hour];
}

- (NSString *)zn_format_mm{
    NSDate *date = [NSDate zn_dateWithDateString:self];
    return [NSString stringWithFormat:@"%02ld",date.minute];
}

- (NSString *)zn_format_ss{
    NSDate *date = [NSDate zn_dateWithDateString:self];
    return [NSString stringWithFormat:@"%02ld",date.seconds];
}

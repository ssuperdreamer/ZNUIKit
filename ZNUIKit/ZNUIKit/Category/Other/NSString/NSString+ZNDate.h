 ...
 *  HH
 */
@property(nonatomic,copy,readonly)NSString *zn_format_HH;

/**
 *  mm
 */
@property(nonatomic,copy,readonly)NSString *zn_format_mm;

/**
 *  ss
 */
@property(nonatomic,copy,readonly)NSString *zn_format_ss;
